...
<link href="../../../css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
<div class="col-xs-12">
		<h2 class="text-center"><label><span class="glyphicon glyphicon-user"></span> Novo Funcionário</label></h2>
</div>
<form action="${linkTo[FuncionarioController].cadastrar(null, null, null)}"
