   <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="col-xs-12">
	<h2 class="text-center"><label><span class="glyphicon glyphicon-list-alt"></span> Lista de Penduras Fiscais</label></h2>
	</div>
	<form action="${linkTo[PenduraController].lista_data_nf(null, null) }"
	method="get">
	<div class="col-xs-4">
	<h3>Início:</h3>
	<input type="text" class="form-control data_formata" name="inicio" />
	</div>
	<div class="col-xs-4">
	<h3>Fim:</h3>
	<input type="text" class="form-control data_formata" name="fim" />
	</div>
	<div class="col-xs-4">
	<h3>Pesquisar</h3>
