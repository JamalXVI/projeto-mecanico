   <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="col-xs-12">
	<h2 class="text-center"><label><span class="glyphicon glyphicon-list-alt"></span> Lista de Penduras da Execução ${executado.orcamento.solicitacao.solicitacoes }</label></h2>
	</div>
<div class="col-xs-12">
        ...
        <tbody> 
          ...
          <c:if test="${!p.pago }">
                <tr>
					...
					<c:if test="${p.nota_fiscal }">
					<a href="#" onclick="iniciar_modal_fiscal('${p.numero_nota}','${p.duplicata }' )"	> <span
...
<c:import url="/WEB-INF/jsp/pendura_modal/modal_fiscal.jsp" />
