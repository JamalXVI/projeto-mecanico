   <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <form role="form" id="pesquisar_form" action="${linkTo[SolicitacaoController].listar_id(pesquisa)}" method="get" class="">
        <div class="input-group col-xs-8 col-md-10" > 
            <input type="text" class="form-control" placeholder="Filtrar pesquisa por Código" name="pesquisa"/>
