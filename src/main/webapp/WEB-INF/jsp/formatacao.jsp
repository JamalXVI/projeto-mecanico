<script type="text/javascript">
  $(function formatacao_formatada() {
    $('.data_formata').mask('00/00/0000');
    $('.data_aniversario').mask('00/00');
    $('.horario').mask('00:00');
    $('.horario_dia').mask('00/00/0000 00:00');
    $('.cep').mask('00000-000');
    $('.phone').mask('0000-0000');
    $('.dporcentagem').mask('% 000.00');
    $('.dvalor').mask('R$ 0000.00');
    ...
    $('.dinheiro').mask("0000.00", {reverse: true});
