...
<div class="col-xs-12">
	<h2 class="text-center"><label><span class="glyphicon glyphicon-compressed"></span> Novo Fabricante</label></h2>
</div>
<form action="${linkTo[FornecedorController].cadastrar(null, null)}"
	...
	<div class="col-sm-6 col-md-8 col-lg-3">   
		...
		<div class="col-sm-6 col-md-6 col-lg-3">
			<label>Condição Pagamento</label>
			  <input id="condicao_pagamento" type="text" value="0" name="fornecedor.condicao_pagamento"
