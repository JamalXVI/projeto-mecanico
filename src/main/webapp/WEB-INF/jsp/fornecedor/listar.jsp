   <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="col-xs-12">
		<h2 class="text-center"><label><span class="glyphicon glyphicon-compressed"></span> Lista Fabricante</label></h2>
	</div>
    <form role="form" id="pesquisar_form" action="${linkTo[FornecedorController].listar(pesquisa)}" method="get" class="">
    ...
    <table class="table table-hover table-bordered table-striped tablesorter" id="tabClientes">
        ...
        <tbody> 
          <c:forEach items="${fornecedores}" var="c">
                <tr>
                    <td>
...
<c:import url="/WEB-INF/jsp/deletar/modal_deletar_fornecedor.jsp" />
<script>
