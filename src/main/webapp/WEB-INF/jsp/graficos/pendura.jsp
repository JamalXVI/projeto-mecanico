...
<c:import url="/WEB-INF/jsp/header.jsp" />
 ...
 <div class="col-xs-12 col-md-12 text-center">
	 <h2><label><span class="glyphicon glyphicon-check"></span> Pendura</label></h2>
 </div>
 ...
 var ativar_graficos = function(){
	 ...
	 $.ajax(
			 {
			 	type: "GET",
			 	url: '<c:url value="/Json/Graficos/Pendura/'+ano+'/'+mes+'"/>',
			 	dataType:'json',
			 	success: function(soma){
			 		...
			 		document.getElementById("txt_gastos").value  = Number(gasto).toFixed(2);
			 		 ...
			 		 var data = {
			 				labels: ["Não Pago "+Math.round(gasto/ total * 100) + '%',
			 				         "Pago "+Math.round(ganho/ total * 100) + '%'],
			 				  series: [gasto,ganho]
			 				};
			 		var options = {
