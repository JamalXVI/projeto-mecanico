...
<div class="col-xs-12">
	<h2 class="text-center"><label><span class="glyphicon glyphicon-compressed"></span> Editar Produtor</label></h2>
</div>
<form action="${linkTo[ProdutorController].editado(null, null)}"
	method="post" enctype="multipart/form-data" role="form">
	<input type="hidden" name="produtor.id" id="idp" value="${produtor.id}" /> 
	<input type="hidden" name="produtor.identificacao.id" id="idid" 
	value="${produtor.identificacao.id}" /> 
	...
	<div class="col-sm-6 col-md-8 col-lg-3">   
		...
		<div class="col-sm-6 col-md-6 col-lg-3">
			<label>Condição Pagamento</label>
			  <input id="condicao_pagamento" type="text" name="produtor.condicao_pagamento"
...
var atualizar_telefones = function(){
	$.ajax({
		type:"GET",
		url: '<c:url value="/Json/Produtor/Telefones/'+id_cliente+'"/>',
		dataType:"json",
